        ...
        <ModalRoot {...modalProps} size={ModalSize.MEDIUM}>
            <ModalHeader separator={false}>
                <Text color="header-primary" variant="heading-lg/semibold" tag="h1" style={{ flexGrow: 1 }}>
                    ...
                    (if your text has any numbers or special characters those will not be included in the reaction messages and will cause rate limit (so dont spam them too much))
                </Text> */}
